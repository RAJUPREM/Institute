...
public class StudentDto {
	...
	public StudentDto(String studentName, String studentFathersName, String studentsDOB, String studentGender,
			...
			int discountPercent, int netFee) {
		super();
