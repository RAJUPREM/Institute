...
public class Student {
	...
	public Student(int studentId, String studentName, String studentFathersName, Date studentsDOB, String studentGender,
			String studentAcademicQualification, String studentProfessionalQualification, String studentCategory,
			String studentMobile, Address address, List<Course> course, Fee fee) {
		super();
